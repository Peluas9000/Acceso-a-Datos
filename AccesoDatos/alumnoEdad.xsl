        ...
        <table>
          ...
          <tbody>
            ...
            <xsl:for-each select="alumno">
              ...
              <!-- Calcular la edad (año actual - año de nacimiento) -->
              <xsl:variable name="anio_actual" select="2025"/> <!-- puedes actualizarlo manualmente -->
              <xsl:variable name="anio_nac" select="number(substring(@fecha_nacimiento, 1, 4))"/>
              <xsl:variable name="edad" select="$anio_actual - $anio_nac"/>
